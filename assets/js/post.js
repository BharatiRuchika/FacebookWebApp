        ...
        newPostForm.submit(function(e){
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    // let newpostDom = newPostDom(data.data.post,data.data.user)
                    // $('#post-container').append(newpostDom)
...
let newPostDom = function(post,user){
    ...
    <div class="row react-section" id="like-comment-count-section">
        <div class="col-12">
            <div class="row">
                <div class="col-3 post-reactions-container" id="${post._id}" data-emojis="${JSON.stringify(post.emojis)}">
